...
def create_lawa_pytree(
    checkpoint_dir: str = "checkpoints", k: int = 5, state: Any = None
):
    ...
    for ckpt in ckpt_steps:
        state_new = checkpoints.restore_checkpoint(
            checkpoint_dir, step=ckpt, target=state
        )
