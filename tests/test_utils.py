...
@pytest.mark.parametrize(
    "labels, logits",
    [
        (jnp.array([[1]], dtype = jnp.int32),jnp.array([[-0.5,1.2,2.4,-3.2]], dtype = jnp.float32)),
        (jnp.array([[3]], dtype = jnp.int32),jnp.array([[1.2,2.4,-0.5,-3.2]], dtype = jnp.float16)),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        (jnp.array([[1]], dtype = jnp.int32),jnp.array([[-0.5,1.2,2.4,-3.2]], dtype = jnp.float32), jnp.array(10.929689)),
        (jnp.array([[3]], dtype = jnp.int32),jnp.array([[1.2,2.4,-0.5,-3.2]], dtype = jnp.float16), jnp.array(32.788956)),
    ]
)
